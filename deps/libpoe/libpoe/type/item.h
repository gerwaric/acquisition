...
namespace libpoe {
    ...
    struct Item {
        ...
        struct LogbookMods {
            ...
            libpoe::Item::LogbookFaction faction; // object
        ...
        std::optional<std::vector<libpoe::ItemSocket>> sockets; // ? array of ItemSocket
        std::optional<std::vector<libpoe::Item>> socketedItems; // ? array of Item
        QString name; // string
        ...
        std::optional<std::vector<libpoe::Item::LogbookMods>> logbookMods; // ? array of object
        ...
        std::optional<std::vector<libpoe::Item::UltimatumMods>> ultimatumMods; // ? array of object
        std::optional<std::vector<QString>> explicitMods; // ? array of string
        ...
        std::optional<libpoe::Item::ExtendedInfo> extended; // ? object only present in the Public Stash API
