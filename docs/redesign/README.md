...
|---|---|---|---|
| rate-limit-core | Can a Rust client demonstrably honor the N-claims in `network-ground-truth.md` under burst load, as a single serialized gate? | cut: `spike/rate-limit-core`; final audit reopened SD-R8 | [Draft verdicts suspended pending SD-R8-F11–F20](topics/rate-limit-core.md) |
