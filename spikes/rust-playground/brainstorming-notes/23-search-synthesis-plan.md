...
| 6 | Build plan: slice steps with their evidence, the parser and printer with a round-trip test first (the owner, 2026-09-19, `search/DESIGN.md`); the digest's acceptance set as acceptance tests; the closed record at the end in `PRICING-SLICE.md`'s mold | Fable | `search/BUILD-PLAN.md`, edited and accepted by the owner 2026-09-19; its "The record" is the step ledger | — |
