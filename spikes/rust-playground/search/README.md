...
| [`legacy/`](legacy/README.md) | How well do Path of Building's version-labelled unique variants match the owner's uniques, and what on this machine says a line — a rare's mod, an enchant, a crucible node — can no longer be made? (the legacy park's trigger, `decisions/search.md`) | second pass complete — 2026-09-18 (fit over selections, catalyst rescale); past budget, nothing cut (Review row 5) | 26998 |
