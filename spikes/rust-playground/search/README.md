...
| [`legacy/`](legacy/README.md) | How well do Path of Building's version-labelled unique variants match the owner's uniques, and what on this machine says a line — a rare's mod, an enchant, a crucible node — can no longer be made? (it fired the legacy park's trigger; ruled 2026-09-18, C107: a unique's variant may be a field, legacy never) | second pass complete — 2026-09-18 (fit over selections, catalyst rescale); past budget, nothing cut (Review row 5) | 26998 |
