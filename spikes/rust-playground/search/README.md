...
| --- | --- | --- | --- |
| [`item-facts/`](item-facts/README.md) | What does an item look like as GGG gives it, and how big is the corpus? | not started | 1857 |
...
| [`trade-query/`](trade-query/README.md) | What is the trade site's query language, and which of it means something for a private stash? | first pass complete — 2026-09-13 | 12037 |
