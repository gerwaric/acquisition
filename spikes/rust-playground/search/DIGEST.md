...
S16 · item · main · `sockets` on 5,922 items (16.4 %), each socket a `{group, attr, sColour}` object: `group` on 5,918, `attr` and `sColour` on 5,894; `stackSize` and `maxStackSize` on 2,749 (7.6 %: Currency 1,322, DivinationCard 884, Normal 543) · F2, field-census.csv ≈ S22, S188
S17 · item · main · Private `explicitMods` lines carry their flags: `crafted` on 1,041 lines (909 items), `fractured` 289 (266), `mutated` 81 (78); no flag seen on any `implicitMods` line · F3, field-census.csv ≈ S3, S50, S51
...
S159 · measure · — · The scan's worst query is the name substring (`q03`) at every scale: 1.27 ms at 36,139, 13.3 at 361,390, 40.8 at 1,084,170; SQLite's worst 3.20, 56.9, 202.7 · F1, Numbers, results.csv ≈ S145, S147
...
1. A line's identity, and a line it cannot name — S3, S4, S5, S11, S12, S17, S25, S27, S28, S29, S43, S44, S45, S47, S48, S52, S63, S64, S65, S66, S67, S71, S72, S73, S76, S84, S101, S102, S103, S104, S105, S106, S107, S109, S110, S111, S154, S155, S156, S165, S171, S178, S186, S196, S200
