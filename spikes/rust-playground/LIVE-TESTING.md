...
## Characters rung — the refresh plan with characters (prepared 2026-09-02; row 1 run 2026-09-02: pass; row 2 run 2026-09-02: both first contacts pass, 4 of 5 fetch bodies refused — rerun after facts v7)
...
error names the array and index, and the same invocation is rerun to
read them — the listing and gerwarshot are fresh, so the plan is the
four refused characters under ceiling 6.
