...
provider, under the existing registration (invariant 4); the CLI
replaces a daemon in the other mode or from another build (C10), and
mock and real refresh tokens are separate keyring entries. The rule is
