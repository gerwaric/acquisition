...
- Opened at step 2 on 2026-09-03; re-scoped 2026-09-04. Annotations
  schema **v3** (provenance on every row; the owner's v2 file migrates
  on its next open), facts **v7**, sync policy **v3**, plan schema
