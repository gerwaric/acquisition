...
1. **The currency table v1** (C68): the 39 words the game writes
   ...
   for the 23 new rows from a browser read or the owner; shipped in the
...
1. Are the two manual rows (a character item at 2222 `jew`; one tab
   ...
   drop?
2. Display names for the 23 new currency rows: from a browser read of
   the trade site's item-tag list, or named by you from the game?
3. C73 parked as "a 0.18 user asks": pricing is niche, but the 0.18
