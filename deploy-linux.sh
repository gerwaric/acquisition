...
export QMAKE=${HOME}/Development/Qt/6.8.2/gcc_64/bin/qmake

LINUXDEPLOY=${HOME}/Development/linuxdeploy/linuxdeploy-x86_64.AppImage
PROJECT_DIR=${PWD}
BUILD_DIR=${PWD}/build/Desktop_Qt_6_8_2-Release
